...
dotenv_1.config();
var accountMail = process.env.MAIL;
var accountPassword = process.env.MAIL_PASSWORD;
/**
 ...
 */
var sendMail = function (email, mailSubject, model) { return __awaiter(void 0, void 0, void 0, function () {
