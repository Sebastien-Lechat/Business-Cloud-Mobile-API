 ...
 */
var generateArticleJSON = function (article) {
    var toReturn = {
        _id: article._id,
        name: article.name,
        price: article.price,
 ...
 * @return Retourne le JSON
 */
var getArticleList = function () { return __awaiter(void 0, void 0, void 0, function () {
    var articleList, articles;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                articleList = [];
                return [4 /*yield*/, globalUtils_1.globalUtils.findMany(Article_1.Article, {})];
            case 1:
                articles = _a.sent();
...
var articleUtils = {
    generateArticleJSON: generateArticleJSON,
    getArticleList: getArticleList
};
exports.articleUtils = articleUtils;
