 ...
 */
var generateEstimateJSON = function (estimate) {
    var toReturn = {
 ...
 * @return Retourne le JSON
 */
var getEstimateList = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    var estimateList;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, globalUtils_1.globalUtils.findManyAndPopulate(Estimate_1.Estimate, { clientId: mongoose_1.default.Types.ObjectId(user.data._id) }, ['articles.articleId'])];
            case 1:
                // Récupération de tous les devis concernants ce client
                estimateList = _a.sent();
                // Mise en forme
                estimateList = estimateList.map(function (estimate) {
                    estimate.articles.map(function (article) {
                ...
                // Envoi de la liste
                return [2 /*return*/, estimateList];
            case 2:
                if (!(user.type === 'user')) return [3 /*break*/, 7];
                if (!(user.data.role === 'Gérant')) return [3 /*break*/, 4];
                return [4 /*yield*/, globalUtils_1.globalUtils.findManyAndPopulate(Estimate_1.Estimate, {}, ['articles.articleId'])];
            case 3:
                ...
                // Envoi de la liste
                return [2 /*return*/, estimateList];
            case 4: return [4 /*yield*/, globalUtils_1.globalUtils.findManyAndPopulate(Estimate_1.Estimate, {}, ['clientId', 'articles.articleId'])];
            case 5:
                // Récupération de tous les devis
                estimateList = _a.sent();
                // Filtre de tout ce qui ne concerne pas l'employé
                estimateList = estimateList.filter(function (estimate) {
                    var client = estimate.clientId;
            ...
            case 7: return [2 /*return*/, estimateList];
            case 8: return [2 /*return*/];
        }
    });
}); };
var estimateUtils = {
    generateEstimateJSON: generateEstimateJSON,
    getEstimateList: getEstimateList
};
exports.estimateUtils = estimateUtils;
