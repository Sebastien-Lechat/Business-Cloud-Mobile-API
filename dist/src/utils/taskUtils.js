 ...
 */
var generateTaskJSON = function (task) {
    var toReturn = {
        id: task._id,
        name: task.name,
 ...
 * @return Retourne le JSON
 */
var getTaskList = function (projectId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, globalUtils_1.globalUtils.findMany(Task_1.Task, { projectId: projectId })];
            case 1:
                tasks = _a.sent();
                // Mise en forme
            ...
            case 2: return [4 /*yield*/, globalUtils_1.globalUtils.findMany(Task_1.Task, {})];
            case 3:
                tasks = _a.sent();
                // Mise en forme
                tasks.map(function (task) {
...
var taskUtils = {
    generateTaskJSON: generateTaskJSON,
