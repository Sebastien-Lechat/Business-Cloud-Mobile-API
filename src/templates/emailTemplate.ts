...
const sendBillModel = (name: string, reason: 'de la facture' | 'du devis', num: string, date: string, exceed: boolean) => {
    return `
<!doctype html>
<html lang="fr-FR">
                    ...
                    <tr>
                        <td>
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:20px;font-family:'Rubik',sans-serif;">` + name + `, vous faites l'objet d'une relance pour le payement ` + reason + `: ` + num + `.</h1>
                                        <span style="display:inline-block; vertical-align:middle; margin:16px 0 26px; border-bottom:1px solid #cecece; width: 45%;">&nbsp;</span>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            La date limite de payement ` + reason + `: ` + num + ` ` + ((exceed) ? `était le: ` + date : `est le: ` + date) + `. Merci de bien vouloir vous connectez à l'application mobile afin de ` + ((reason === 'de la facture') ? `régler cette facture` : `confirmer le devis`) + `.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
...
const sendFileModel = (name: string, reason: 'de la facture' | 'du devis', num: string, date: string, exceed: boolean) => {
    return `
<!doctype html>
<html lang="fr-FR">
                    ...
                    <tr>
                        <td>
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#1e1e2d; font-weight:500; margin:0;font-size:20px;font-family:'Rubik',sans-serif;">` + name + `, vous avez demander l'obtention ` + reason + `: ` + num + `.</h1>
                                        <span style="display:inline-block; vertical-align:middle; margin:16px 0 26px; border-bottom:1px solid #cecece; width: 45%;">&nbsp;</span>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            La date limite de payement ` + reason + `: ` + num + ` ` + ((exceed) ? `était le: ` + date : `est le: ` + date) + `.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
...
export { passwordLostModel, sendCodeModel, sendBillModel, sendFileModel };
